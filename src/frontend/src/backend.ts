...
import type { AssessmentResult as _AssessmentResult, AssessmentResultType as _AssessmentResultType, AssessmentType as _AssessmentType, Certificate as _Certificate, Course as _Course, CourseId as _CourseId, CourseProgress as _CourseProgress, EngagementMetrics as _EngagementMetrics, Result as _Result, Result_1 as _Result_1, Result_2 as _Result_2, Result_3 as _Result_3, StripeSessionStatus as _StripeSessionStatus, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async finalizeCoursePurchase(arg0: string, arg1: string): Promise<Result_1> {
        if (this.processError) {
            try {
                const result = await this.actor.finalizeCoursePurchase(arg0, arg1);
    ...
    async getCourse(arg0: string): Promise<Result_3> {
        if (this.processError) {
            try {
                const result = await this.actor.getCourse(arg0);
                return from_candid_Result_3_n23(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getCourses(): Promise<Result_2> {
        if (this.processError) {
            try {
    ...
    async updateCoursePrice(arg0: string, arg1: bigint): Promise<Result> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCoursePrice(arg0, arg1);
...
function from_candid_AssessmentResultType_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AssessmentResultType): AssessmentResultType {
    return from_candid_variant_n18(_uploadFile, _downloadFile, value);
}
function from_candid_AssessmentResult_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AssessmentResult): AssessmentResult {
    return from_candid_record_n16(_uploadFile, _downloadFile, value);
}
function from_candid_AssessmentType_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AssessmentType): AssessmentType {
...
function from_candid_Result_3_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Result_3): Result_3 {
...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    id: Principal;
    isInstructor: boolean;
    earnedCertificates: Array<_Certificate>;
    assessmentHistory: Array<_AssessmentResult>;
    engagementMetrics: _EngagementMetrics;
    name: string;
    purchasedCourses: Array<_CourseId>;
    courseProgress: Array<_CourseProgress>;
}): {
    id: Principal;
    isInstructor: boolean;
    earnedCertificates: Array<Certificate>;
    ...
    return {
        ...
        earnedCertificates: value.earnedCertificates,
        assessmentHistory: from_candid_vec_n14(_uploadFile, _downloadFile, value.assessmentHistory),
        engagementMetrics: value.engagementMetrics,
        name: value.name,
        purchasedCourses: value.purchasedCourses,
        courseProgress: value.courseProgress
    };
}
function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    result: _AssessmentResultType;
    ...
    return {
        result: from_candid_AssessmentResultType_n17(_uploadFile, _downloadFile, value.result),
        assessmentType: from_candid_AssessmentType_n19(_uploadFile, _downloadFile, value.assessmentType),
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "quiz" in value ? AssessmentType.quiz : "codingChallenge" in value ? AssessmentType.codingChallenge : value;
}
...
function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AssessmentResult>): Array<AssessmentResult> {
    return value.map((x)=>from_candid_AssessmentResult_n15(_uploadFile, _downloadFile, x));
}
...
function to_candid_AssessmentResultType_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AssessmentResultType): _AssessmentResultType {
    return to_candid_variant_n39(_uploadFile, _downloadFile, value);
}
function to_candid_AssessmentResult_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AssessmentResult): _AssessmentResult {
    return to_candid_record_n37(_uploadFile, _downloadFile, value);
}
function to_candid_AssessmentType_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AssessmentType): _AssessmentType {
...
function to_candid_record_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        isInstructor: value.isInstructor,
        earnedCertificates: value.earnedCertificates,
        assessmentHistory: to_candid_vec_n35(_uploadFile, _downloadFile, value.assessmentHistory),
        engagementMetrics: value.engagementMetrics,
        name: value.name,
        purchasedCourses: value.purchasedCourses,
        courseProgress: value.courseProgress
...
function to_candid_record_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        result: to_candid_AssessmentResultType_n38(_uploadFile, _downloadFile, value.result),
        assessmentType: to_candid_AssessmentType_n40(_uploadFile, _downloadFile, value.assessmentType),
        timestamp: value.timestamp,
        assessmentId: value.assessmentId
    };
}
function to_candid_variant_n39(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return value.__kind__ === "feedback" ? {
        feedback: value.feedback
    } : value.__kind__ === "score" ? {
        score: value.score
    } : value.__kind__ === "success" ? {
        success: value.success
    } : value;
}
function to_candid_variant_n41(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AssessmentType): {
    quiz: null;
} | {
    codingChallenge: null;
} {
    return value == AssessmentType.quiz ? {
        quiz: null
    } : value == AssessmentType.codingChallenge ? {
        codingChallenge: null
    } : value;
}
...
function to_candid_vec_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<AssessmentResult>): Array<_AssessmentResult> {
    return value.map((x)=>to_candid_AssessmentResult_n36(_uploadFile, _downloadFile, x));
}
